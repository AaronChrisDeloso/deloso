...
{
    public abstract class delosoWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static delosoWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(delosoWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<delosoDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<delosoDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<delosoDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<delosoDbContext, Task<T>> func)
        {
            T result;
